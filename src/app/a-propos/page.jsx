          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 border border-gray-100">
            <div className="flex flex-col items-center text-center gap-6">
              <div className="w-56 h-56 rounded-2xl overflow-hidden shadow-xl">
                <img
                  src="/user.jpeg"
                  alt="Dr Manga Makrada Maïna - Président de l'EHETIP"
                  className="w-full h-full object-cover"
                />
              </div>

              <h3 className="text-3xl md:text-4xl font-extrabold leading-tight" style={{ color: primaryBlue }}>
                Dr Manga Makrada Maïna
              </h3>
              <p className="text-sm uppercase font-semibold" style={{ color: gold }}>
                Président de l'EHETIP
              </p>

              <div className="mt-6 text-gray-700 space-y-4 text-lg leading-relaxed max-w-3xl">
                <p className="font-medium">
                  Le Président de l’EHETIP, Dr Manga Makrada Maïna, est enseignant-chercheur, historien et économiste de formation. Titulaire d’un doctorat, il a un parcours académique et professionnel marqué par une forte implication dans l’enseignement supérieur, la recherche, l’analyse économique et la gouvernance publique.
                </p>

                <p>
                  Sa carrière combine l’enseignement universitaire, la recherche scientifique, l’expertise en politiques publiques et coopération internationale, ainsi que l’accompagnement institutionnel et stratégique de projets publics et privés.
                </p>

                <div className="mt-4 p-4 rounded-lg bg-gray-50 border-l-4 border-[#d4af37] text-left">
                  <p className="text-gray-800">
                    « À travers la création et la présidence de l’EHETIP, il porte une vision claire : former une nouvelle génération de cadres compétents, rigoureux et responsables, capables d’analyser les enjeux contemporains et d’agir efficacement au service des institutions et du développement. »
                  </p>
                </div>

                <p>
                  L’EHETIP s’inscrit ainsi dans une dynamique d’excellence académique, de professionnalisation et d’ouverture sur le monde, en cohérence avec les réalités africaines et les standards internationaux de l’enseignement supérieur.
                </p>
              </div>

              <div className="mt-6 flex flex-wrap justify-center gap-3">
                <span className="inline-block px-3 py-1 rounded-full bg-[#eff6ff] text-sm font-medium" style={{ color: primaryBlue }}>
                  Enseignant-chercheur
                </span>
                <span className="inline-block px-3 py-1 rounded-full bg-[#fff7ed] text-sm font-medium" style={{ color: '#b45309' }}>
                  Historien & Économiste
                </span>
                <span className="inline-block px-3 py-1 rounded-full bg-[#f0fdf4] text-sm font-medium" style={{ color: '#166534' }}>
                  Politique publique
                </span>
              </div>
            </div>
