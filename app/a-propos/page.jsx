          ...
          <div className="flex flex-col lg:flex-row gap-20 items-center">
            ...
            <div className="flex-1">
              ...
              <div className="space-y-6 text-gray-600 text-lg leading-relaxed">
                <p>
                  Fondée avec la conviction que l'éducation est le moteur du
                  changement, l'EHETIP a commencé son aventure avec une poignée
                  d'étudiants passionnés.
                </p>
                <p>
                  Aujourd'hui, nous accueillons des centaines d'étudiants venus
                  de tout le pays et de la sous-région, attirés par la qualité
                  de notre corps professoral et la pertinence de nos programmes.
                </p>
                <p>
                  Notre succès se mesure à travers la réussite de nos diplômés,
                  qui occupent aujourd'hui des postes clés dans l'administration
                  publique, les organisations internationales et le secteur
                  privé.
                </p>
              </div>
            </div>
